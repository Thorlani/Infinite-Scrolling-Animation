...
imagesLoaded(
  ...
  () => {
    ...
    // first three items
    [...document.querySelectorAll(".grid__item:nth-child(-n+3)")].forEach(
      (el) => {
        gsap.set(el, { transformOrigin: `100% 100%` });
        gsap.to(el, {
          ease: "none",
          startAt: { scale: 1 },
          scale: 0,
    ...
    // last three items
    [...document.querySelectorAll(".grid__item:nth-last-child(-n+3)")].forEach(
      (el) => {
    ...
    [
      ...document.querySelectorAll(
        ".grid__item:nth-child(4), .grid__item:nth-child(5), .grid__item:nth-child(6)"
      ),
    ].forEach((el) => {
      ft = gsap.timeline().to(el, {
        scrollTrigger: {
          trigger: el,
          start: "top bottom",
          end: "center center",
